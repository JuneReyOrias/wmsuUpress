    ...
    <div class="col-md-12 grid-margin">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <h6 class="card-title"><span>I.</span>Create Services</h6>
         ...
         {{-- <p class="text-muted mb-3">Read the <a href="https://github.com/RobinHerbots/Inputmask" target="_blank"> Official Inputmask Documentation </a>for a full list of instructions and other options.</p> --}}
          <form action{{url('updateservices')}} method="post" enctype="multipart/form-data">
            @csrf
              ...
              <div class="col-md-3">
                  ...
                  <input  class="form-control mb-4 mb-md-0" name="category" placeholder="category" type="text" value="{{$servicescat->category}}" aria-label="FirstName"id="floatingInput">
              ...
              <div class="col-md-3">
                <div class="form-floating mb-4 mb-md-0">
                <input  class="form-control " name="description" placeholder="description" type="text" value="{{$servicescat->description}}" aria-label="descritpion"id="floatingInput">
...
<div  class="d-grid gap-2 d-md-flex justify-content-md-end">
  <button  type="submit" class="btn btn-success me-md-2">Update</button></a></p>
</div>
          </form>
