    ...
    <div class="col-md-12 grid-margin">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <h6 class="card-title"><span>I.</span>Create Product and Services Code</h6>
         ...
         {{-- <p class="text-muted mb-3">Read the <a href="https://github.com/RobinHerbots/Inputmask" target="_blank"> Official Inputmask Documentation </a>for a full list of instructions and other options.</p> --}}
          <form action{{url('addcodes')}} method="post" enctype="multipart/form-data">
            @csrf
              ...
              <div class="col-md-3">
                  ...
                  <input  class="form-control mb-4 mb-md-0" name="unique_name" placeholder="material_name" type="text" aria-label="FirstName"id="floatingInput">
   ...
   <table class="table table table-info">
       <thead class="thead-light">
           <tr >
               ...
               <td style="padding:20px">Code Name</td>
